...
Palma Hall Main Entrance	Main Entrance to Palma Hall	14.6536749999999998	121.069888000000006	palma-hall-main-entrance	892	7	\N
Palma Hall - ASCAL Entrance	Side entrance to Palma Hall. This entrance is located between Palma Hall (AS) and the former Faculty Center	14.6534895489531998	121.068889915705	palma-hall-ascal-entrance	893	7	
\.


--
-- Data for Name: location_before; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.location_before (name, category, description, more_info, lat, lng, url, id) FROM stdin;
...
--
-- Name: administrator_before DiskoverApp_administrator_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.administrator_before
    ADD CONSTRAINT "DiskoverApp_administrator_pkey" PRIMARY KEY (username);


--
-- Name: inside_before DiskoverApp_inside_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.inside_before
...
CREATE INDEX "DiskoverApp_administrator_username_404381de_like" ON public.administrator_before USING btree (username varchar_pattern_ops);
...
CREATE INDEX "DiskoverApp_inside_room_31dc4780_like" ON public.inside_before USING btree (room varchar_pattern_ops);
...
ALTER TABLE ONLY public.location
    ADD CONSTRAINT location_category_fkey FOREIGN KEY (category_id) REFERENCES public.category(id) ON DELETE CASCADE;
