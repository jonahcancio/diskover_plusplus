...
CREATE TABLE public.category (
    ...
    image character varying(260) NOT NULL,
    "position" integer NOT NULL,
    url character varying(50) NOT NULL,
    marker character varying(260) NOT NULL,
    "routeMarker" character varying(260) NOT NULL,
    "routeColor" character varying(7) NOT NULL
);
...
2	pbkdf2_sha256$120000$XG6DpBale1GI$dsEx9xOk1pMUtIBC4GGdJiubLe/xRAu90cnGbRuLJ0c=	2019-03-22 10:29:00.146754+08	t	d4cteam			diskoverplusplus@gmail.com	t	t	2019-03-22 10:23:37.992844+08
\.
...
COPY public.category (name, image, "position", url, marker, "routeMarker", "routeColor") FROM stdin;
College Buildings	college.jpg	1	college-buildings	schoolIcon.png	schoolRouteIcon.png	#1E90FF
Rooms	room.jpg	2	rooms	schoolIcon.png	schoolRouteIcon.png	#1E90FF
Food Service	food.jpg	3	food-service	foodIcon.png	foodRouteIcon.png	#B22222
Parking Areas	parking.jpg	4	parking-lots	parkingIcon.png	parkingRouteIcon.png	#800080
Comfort Rooms	toilet.jpg	5	comfort-rooms	toiletIcon.png	toiletIcon.png	#FF7F50
Jeepney Stops	jeepstop.jpg	6	jeepney-stops	jeepstopIcon.png	jeepstopRouteIcon.png	#B22222
\.
...
COPY public.location (name, category, description, "moreInfo", lat, lng, url, id) FROM stdin;
...
SELECT pg_catalog.setval('public.location_id_seq', 890, true);
...
--
-- Name: category DiskoverApp_category_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.category
    ADD CONSTRAINT "DiskoverApp_category_pkey" PRIMARY KEY (name);
