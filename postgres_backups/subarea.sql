...
2	pbkdf2_sha256$120000$XG6DpBale1GI$dsEx9xOk1pMUtIBC4GGdJiubLe/xRAu90cnGbRuLJ0c=	2019-03-31 15:07:37.103761+08	t	d4cteam			diskoverplusplus@gmail.com	t	t	2019-03-22 10:23:37.992844+08
\.
...
ALTER TABLE ONLY public.subarea
    ADD CONSTRAINT subarea_building_fkey FOREIGN KEY (building_id) REFERENCES public.location(id);
...
ALTER TABLE ONLY public.subarea
    ADD CONSTRAINT subarea_sub_fkey FOREIGN KEY (sub_id) REFERENCES public.location(id);
